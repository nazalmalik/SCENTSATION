 ...
 const { products } = useContext(ShopContext);
  ...
  useEffect(() => {
    ...
    filtered = filtered.filter(
      (product) => product.category.toLowerCase() === "unisex"
    );
  ...
  return (
    <div className="d-flex flex-column p-0 border-top">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${assets.unisex_banner})`, // Replace with your image URL
      ...
      <div className="d-flex flex-column flex-sm-row gap-3 p-5">
        ...
        <div className="product-grid">
          <h2 className="fs-2 fw-bold mb-4 text-center p-4">Men's and Women Perfumes</h2>
          {/* Flexbox Layout */}
          <div
