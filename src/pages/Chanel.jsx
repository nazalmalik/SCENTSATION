  ...
  // Toggle Seasons filter
    ...
    useEffect(() => {
      ...
      filtered = filtered.filter(
        (product) => product.category.toLowerCase() === "chanel"
      );
    
      // Apply Seasons filter
      if (Seasons.length > 0) {
        filtered = filtered.filter((product) => Seasons.includes(product.seasons));
      }
  ...
  return (
    <div className="d-flex flex-column p-0 border-top">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${assets.chanel_banner})`, // Replace with your image URL
          ...
          >
            ...
            <div className="d-flex flex-column gap-2">
              {["spring", "summer", "autumn", "winter"].map((season) => (
                <p key={season} className="d-flex gap-2">
                  <input
