  ...
  return (
    <div className="d-flex flex-column p-0 border-top">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${assets.women_banner})`, // Replace with your image URL
      ...
      <div className="d-flex flex-column flex-sm-row gap-3 p-5">
        ...
        <div className="product-grid">
          <h2 className="fs-3 fw-bold mb-4 p-4 text-center" style={{marginLeft:'90px'}}>Womens Perfumes</h2>
          {/* Flexbox Layout */}
          <div
